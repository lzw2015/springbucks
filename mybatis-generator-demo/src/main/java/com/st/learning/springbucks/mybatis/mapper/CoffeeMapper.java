...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Thu Sep 30 14:06:14 CST 2021
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.st.learning.springbucks.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.st.learning.springbucks.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.st.learning.springbucks.mybatis.handler.MoneyTypeHandler},",
